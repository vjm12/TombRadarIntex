...
{
    public class fagContext : DbContext
    {
        public fagContext()
        {
        }

        public fagContext(DbContextOptions<fagContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseNpgsql("SServer=intex.c7btmthrva1n.us-east-1.rds.amazonaws.com;Port=5432;Database=fag;User Id=postgres;Password=thisisstupid");
            }
        }
